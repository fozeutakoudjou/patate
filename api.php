<?php
use Applications\Webservice\WebserviceApplication;
...
else
{
	...
	header('WWW-Authenticate: Basic realm="Welcome to Finder Webservice, please enter the authentication key as the login. No password required."');
	die;
}
